...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=Gvh30BiR#_kjY9EGPJebqmVq8XGn7Iz7vsKPOdImL0PX_G-vfLCA' : process.env.SESSION_ID,
...
ANTI_LINK: process.env.ANTI_LINK === undefined ? "true" : process.env.AUTO_sapam,
...
WELCOME_GOODBYE: process.env.WELCOME_GOODBYE === undefined ? "false" : process.env.spam_send,
...
NEWS_SEND_JID: process.env.NEWS_SEND_JID === undefined ? "" : process.env.kill,
